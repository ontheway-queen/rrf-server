...
const deleteQueen_router_1 = __importDefault(require("./queenRouter/deleteQueen.router"));
const deleteCustomer_router_1 = __importDefault(require("./customerRouter/deleteCustomer.router"));
class Routers {
    constructor() {
        ...
        this.DeleteQueenRouter = new deleteQueen_router_1.default().routers;
        this.DeleteCustomerRouter = new deleteCustomer_router_1.default().routers;
    }
}
