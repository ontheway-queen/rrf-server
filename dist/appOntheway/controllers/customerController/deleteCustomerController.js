...
class DeleteCustomerController extends abstractController_1.default {
    constructor() {
        super();
         ...
         * delete Customer
         */
        this.deleteCustomer = this.assyncWrapper.wrap((req, res) => __awaiter(this, void 0, void 0, function* () {
            const data = yield this.customerServices.deleteCustomer(req);
            if (data.success) {
