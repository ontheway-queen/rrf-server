...
class CommonProductServices extends abstractServices_1.default {
    ...
    getAllProducts(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const forCount = "SELECT count(rrf.admin_products.id) as total FROM rrf.admin_products";
    ...
    getAllProductsByStatus(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const forCount = "SELECT count(rrf.admin_products.id) as total FROM rrf.admin_products where rrf.admin_products.status= ?";
    ...
    getAllProductsByCategory(table, req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let forCount = "SELECT count(distinct(admin_products.id)) as total FROM rrf.admin_products where admin_products.category = ? and admin_products.status = 'approved'";
            if (category === "recent-product") {
                forCount =
                    "SELECT count(distinct(admin_products.id)) as total FROM rrf.admin_products where and admin_products.status = 'approved'";
            }
            if (table === "admin_products") {
                forCount =
                    "SELECT count(distinct(rrf.admin_products.id)) as total FROM rrf.admin_products where admin_products.category = ?";
                if (category === "recent-product") {
                    forCount =
                        "SELECT count(distinct(rrf.admin_products.id)) as total FROM rrf.admin_products";
                }
            }
            else {
                if (category === "recent-product") {
                    forCount =
                        "SELECT count(distinct(rrf.admin_products.id)) as total FROM rrf.admin_products where admin_products.status = 'approved'";
                }
            }
            let count;
            if (category === "recent-product") {
    ...
    getAllProductsByCategoryAndStatus(table, req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (table === "admin_products") {
                const forCount = "SELECT count(distinct(rrf.admin_products.id)) as total FROM rrf.admin_products where admin_products.category = ? and admin_products.status = ?";
