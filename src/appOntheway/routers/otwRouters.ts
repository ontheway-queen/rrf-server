...
import DeleteQueenRouter from "./queenRouter/deleteQueen.router";
import DeleteCustomerRouter from "./customerRouter/deleteCustomer.router";
...
class Routers {
  ...
  public DeleteQueenRouter = new DeleteQueenRouter().routers;
  public DeleteCustomerRouter = new DeleteCustomerRouter().routers;
}
