...
class CommonProductServices extends AbstractServices {
  ...
  public async getAllProducts(req: Request) {
    ...
    const forCount =
      'SELECT count(rrf_ecommerce.admin_products.id) as total FROM rrf_ecommerce.admin_products';
  ...
  public async getAllProductsByStatus(req: Request) {
    ...
    const forCount =
      'SELECT count(rrf_ecommerce.admin_products.id) as total FROM rrf_ecommerce.admin_products where rrf_ecommerce.admin_products.status= ?';
  ...
  public async getAllProductsByCategory(table: string, req: Request) {
    ...
    let forCount =
      "SELECT count(distinct(admin_products.id)) as total FROM rrf_ecommerce.admin_products where admin_products.category = ? and admin_products.status = 'approved'";
  ...
  public async getAllProductsByCategoryAndStatus(table: string, req: Request) {
    ...
    if (table === 'admin_products') {
      const forCount =
        'SELECT count(distinct(rrf_ecommerce.admin_products.id)) as total FROM rrf_ecommerce.admin_products where admin_products.category = ? and admin_products.status = ?';
